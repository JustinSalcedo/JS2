...
var NAV_BAR_HEIGHT = 88; // const heading1 = document.querySelector('h1')
// heading1.addEventListener("click", scrollToTop)

var burgerBtn = document.querySelector('button.nav-burger');
...
var themeBtns = document.querySelectorAll('.switch-theme');
Array.from(themeBtns).forEach(function (themeBtn) {
...
function addWhiteIcons() {
  var iconsList = document.querySelectorAll('.nav-footer .social-links img, .contact-info.alt-lyt .social-links img');
  Array.from(iconsList).forEach(function (iconElement) {
    var originalSrc = iconElement.getAttribute('src');

    if (!originalSrc.match("-white.")) {
      var newSrc = originalSrc.replace('.', '-white.');
...
var ScrollingRegister = /*#__PURE__*/function () {
  function ScrollingRegister() {
    _classCallCheck(this, ScrollingRegister);

    this.lastScrollY = 0;
    this.scrollDirection = null;
  }

  _createClass(ScrollingRegister, [{
    key: "setScrollY",
    value: function setScrollY(scrollYPos) {
    ...
    key: "defineScrollDirection",
    value: function defineScrollDirection(scrollYPos) {
    ...
    key: "setDirection",
    value: function setDirection(scrollDirection) {
  ...
  return ScrollingRegister;
}();

var scrollingRegister = new ScrollingRegister();
var ticking = false;
...
var portfolioAnchorLink = document.querySelector(".nav-content a[href='index.html#portfolio']");
...
var missingGroups = Array.from(document.querySelectorAll('.input-group.missing'));
missingGroups.forEach(function (msGroup) {
...
function cropAllBlogSums() {
  var paraHeight = 100;
  var blogSumNodes = Array.from(document.querySelectorAll('.blog-desc .blog-sum'));

  if (blogSumNodes.length && blogSumNodes[0]) {
    blogSumNodes.forEach(function (sumNode) {
...
function cropText(maxH, node) {
  while (node.offsetHeight > maxH) {
    var textList = node.textContent.split(' ').slice(0, -1);
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/badges"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/badges"], () => (__webpack_require__("./resources/css/badges.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/badges"], () => (__webpack_require__("./resources/css/app.css")))
